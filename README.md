...
### 3. 이전에 제작한 CatchMind 프로젝트에서 어려웠던점/문제였던을 해결한다
...
## 해결방법
1. Turn 서버 사용 : p2p가 아니게 되므로 서버 부하 증가. 최후의 상황에서만 사용한다.

2. 미디어 서버 사용 : Turn 서버와 마찬가지로 릴레이 서버이지만 SFU / MCU 의 선택지가 존재하며 피어가 증가할 때 사용 할 방법이다.
